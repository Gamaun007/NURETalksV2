...
describe('RadioButtonComponent', () => {
  ...
  describe('radio button wrapper', () => {
    function getRadioButtonWrapperNativeElement(): HTMLElement {
      return fixture.debugElement.query(By.css('div.radio-button-wrapper'))?.nativeElement;
    }
    ...
    it('should call toggle function if allowToggle is true when click event is triggered', () => {
      ...
      // Act
      getRadioButtonWrapperNativeElement().dispatchEvent(new MouseEvent('click'));
