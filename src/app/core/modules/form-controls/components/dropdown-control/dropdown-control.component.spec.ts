...
//           beforeEach(async () => {
//             await detectChanges();
//             componentUnderTest.isDropdownOpened = true;
//             await detectChanges();
//           });

//           function getDivWithMaxHeight(): DebugElement {
//             return fixture.debugElement.query(By.css('perfect-scrollbar'));
//           }

//           function getDropdownOptions(): DebugElement[] {
//             return getDivWithMaxHeight().queryAll(By.css('app-dropdown-option'));
//           }

//           it('should set max-height for container', async () => {
//             // Arrange
//             // Act
//             // Assert
//             expect(getDivWithMaxHeight().styles['max-height']).toBe(`${componentUnderTest.listMaxHeight}px`);
//           });

//           it('should set height for all options', async () => {
//             // Arrange
//             // Act
//             // Assert
//             expect(getDropdownOptions().length).toBeGreaterThan(0);
//             getDropdownOptions().forEach((optionButtonDebugElement) => {
//               expect(optionButtonDebugElement.styles['height']).toBe(`${componentUnderTest.buttonHeight}px`);
//             });
//           });
//         });
//       });
