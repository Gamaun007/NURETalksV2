...
describe('DynamicFormControlOutletDirective', () => {
  ...
  describe('dynamic-control disabling', () => {
    it('should enable form control component when dynamic form control was enabled', async () => {
      fixture.detectChanges();
    ...
    it('should disable form control component when dynamic form control was disabled', async () => {
      fixture.detectChanges();
  ...
  it('should destroy control component if control is null or undefined', async () => {
    fixture.detectChanges();
    ...
    // Arrange
    const dynamicFormControlOutletDirective: DynamicFormControlOutletDirective =
      controlComponentInstances[0].injector.get(DynamicFormControlOutletDirective);
